...
abstract class ExprModel extends scala.AnyRef {
    ...
    trait VC_TRAIT$ExprModel$Add extends scala.AnyRef { self: Add => 
    ...
    trait VC_TRAIT$ExprModel$Mult extends scala.AnyRef { self: Mult => 
...
object ExprFormat extends scala.AnyRef {
  class VC_FINAL$ExprFormat extends ExprFormat {
    ...
    class VC_FIX$ExprFormat$Constant extends VC_TRAIT$ExprFormat$Constant with VC_TRAIT$ExprModel$Constant with VC_TRAIT$ExprFormat$Expr with VC_TRAIT$ExprModel$Expr {
    };
    type BinExpr = Expr with VC_TRAIT$ExprModel$BinExpr with VC_TRAIT$ExprFormat$BinExpr;
    abstract class VC_FIX$ExprFormat$BinExpr extends VC_TRAIT$ExprFormat$BinExpr with VC_TRAIT$ExprModel$BinExpr with VC_TRAIT$ExprFormat$Expr with VC_TRAIT$ExprModel$Expr {
    };
    object Add extends scala.AnyRef {
      def apply() = VC_NEW$Add
    };
    def VC_NEW$Add = new VC_FIX$ExprFormat$Add();
    type Add = BinExpr with VC_TRAIT$ExprModel$Add with VC_TRAIT$ExprFormat$Add;
    class VC_FIX$ExprFormat$Add extends VC_TRAIT$ExprFormat$Add  with VC_TRAIT$ExprModel$Add with VC_TRAIT$ExprFormat$BinExpr with VC_TRAIT$ExprModel$BinExpr with VC_TRAIT$ExprFormat$Expr with VC_TRAIT$ExprModel$Expr {
    };
    object Mult extends scala.AnyRef {
      def apply() = VC_NEW$Mult
    };
    def VC_NEW$Mult = new VC_FIX$ExprFormat$Mult();
    type Mult = BinExpr with VC_TRAIT$ExprModel$Mult with VC_TRAIT$ExprFormat$Mult;
    class VC_FIX$ExprFormat$Mult extends VC_TRAIT$ExprFormat$Mult with VC_TRAIT$ExprModel$Mult  with VC_TRAIT$ExprFormat$BinExpr with VC_TRAIT$ExprModel$BinExpr with VC_TRAIT$ExprFormat$Expr with VC_TRAIT$ExprModel$Expr {
    }
  };
